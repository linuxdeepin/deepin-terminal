...
> ![tips](../common/tips.svg)窍门 ：右键单击任务栏上的终端图标 ![deepin_terminal](../common/deepin_terminal.svg) ，选择 **雷神终端**，也可以打开雷神模式的终端窗口。
...
### 编辑服务器
1.  打开终端远程管理界面，将光标置于某一个服务器上，会显示按钮 ![edit_icon](../common/edit_icon.svg)，单击该按钮弹出编辑服务器窗口。
2.  修改服务器信息。
3.  单击 **保存**。
...
2. 在 **基础设置** 页签下，您可以：
   ...
   - 设置终端字体样式和字体大小。
3. 在 **标签标题** 页签下，可以对终端中所有标签及远程标签的标题进行设置。
