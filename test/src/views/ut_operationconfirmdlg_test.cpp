...
TEST_F(UT_OperationConfirmDlg_Test, setDialogFrameSize)
{
    OperationConfirmDlg opConfigDlg;
    opConfigDlg.setDialogFrameSize(800, 600);

    EXPECT_EQ(opConfigDlg.size().width(), 800);
    EXPECT_EQ(opConfigDlg.size().height(), 600);
