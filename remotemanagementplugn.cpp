...
QAction *RemoteManagementPlugn::titlebarMenu(MainWindow *mainWindow)
{
    ...
    connect(remoteManagementAction, &QAction::triggered, this, [this]() {
...
void RemoteManagementPlugn::initRemoteManagementTopPanel()
{
    ...
    connect(m_remoteManagementTopPanel, &RemoteManagementTopPanel::doConnectServer, this, &RemoteManagementPlugn::doCennectServer);
}
