...
void GenerateSettingTranslate()
{
    ...
    auto shortcuts_advanced_custom_commandName = QObject::tr("Custom command");
    ...
    auto shortcuts_terminal_skip_to_next_commandName = QObject::tr("Skip to next command");
    auto shortcuts_terminal_skip_to_previous_commandName = QObject::tr("Skip to previous command");
    ...
    auto shortcuts_workspace_horionzal_splitName = QObject::tr("Horionzal split");
