...
QAction *CustomCommandPlugin::titlebarMenu(MainWindow *mainWindow)
{
    ...
    connect(customCommandAction, &QAction::triggered, this, [this]() {
...
void CustomCommandPlugin::initCustomCommandTopPanel()
{
    ...
    connect(m_customCommandTopPanel, &CustomCommandTopPanel::handleCustomCurCommand, this, &CustomCommandPlugin::doCustomCommand);
}
